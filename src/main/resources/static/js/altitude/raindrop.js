var App = function () {
    ...
    this.InitRegions = function () {
        $.ajax({
            url: "ProductCategoryRegionRels/findByCategoryCode?categoryCode=yu-di-pu",
            async: false,
    ...
    this.LoadProducts = function () {
        ...
        var template = 'products/findByTime?type={0}&imagetime={1}&county={2}&categoryCodeValue=yu-di-pu';
